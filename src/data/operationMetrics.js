export const operationMetricDefinitionGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: '调用次数趋势', formula: '将调用总量按当前周期的时间段分别统计。', detail: '今日按时段；近 30 天按自然日；近 90 天按自然周；本年度按上、下半月。各时间段之和等于当前范围调用总量。' },
      { label: '概览卡片折线', formula: '卡片右侧折线展示所选周期内各时间段的变化。', detail: '今日按 09、11、13、15、17、19 时共 6 个节点；近 30 天每天 1 个节点，共 30 个；近 90 天按周绘制 13 个节点，横轴按月份提示阶段；本年度每月上、下半月各 1 个节点，共 14 个。本地演示中，调用量和人均调用按各时间段调用量绘制；完成率和首次响应以当前汇总值为基准，结合各时间段调用变化生成示意曲线。' },
    ],
  },
  {
    id: 'tasks',
  ...
  },
  {
    ...
    items: [
      ...
      { label: '单位活跃用户占比', formula: '该单位活跃用户数 ÷ 该单位注册用户数 × 100%。', detail: '气泡面积表示该比率，面积越大代表活跃覆盖率越高。' },
      { label: '各级单位使用对比', formula: '横轴为单位调用量，纵轴为单位任务完成率，气泡面积为单位活跃用户占比，颜色区分单位。', detail: '全集团显示 6 家二级公司和 10 家三级公司；也可分别查看二级或三级公司。' },
    ],
  },
  {
    id: 'records',
