...
<style scoped>
.application-heading.application-heading { --application-tone: #1688e5; position: relative; isolation: isolate; min-width: 0; min-height: 106px; display: grid; flex: 1 1 auto; grid-template-columns: 64px minmax(0,1fr); align-items: center; gap: 17px; overflow: visible; margin: 0; padding: 0 4px 20px; color: #153f60; background: transparent; text-align: left; }
